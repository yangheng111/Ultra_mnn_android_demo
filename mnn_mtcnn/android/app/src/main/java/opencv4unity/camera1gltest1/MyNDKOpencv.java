...
public class MyNDKOpencv {
    ...
    public Bitmap scanfEffect(byte[] data, int srcWidth, int srcHeight,int model){
        ...
        bitmap.getPixels(pixels,0,tmp_width,0,0,tmp_width,tmp_height);
         ...
         String fileDir = sdcard.getAbsolutePath() + "/mnn_model";
        // String fileDir =  "";

        // Log.i("DEBUG", fileDir);
        ResultFromJni2 resultFromJni2=getScannerEffect(pixels, fileDir, tmp_width,tmp_height, 2);

        //Dealing
        // ResultFromJni2 resultFromJni2=getScannerEffect(pixels,tmp_width,tmp_height,2);
